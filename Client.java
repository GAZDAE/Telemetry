...
public class Client{ 
	...
	private boolean connection;		// Value to see if socket is connected
	...
	// DELETE THE MAIN LATER, USE OR COPY STUFF INSIDE THE MAIN THOUGH
	public static void main (String [] args ) throws IOException { 
		
		// Create client with specified port number
